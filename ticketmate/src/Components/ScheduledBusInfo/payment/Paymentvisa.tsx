...
<div className="container">
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-check form-check-inline">
        ...
        >
          By Continuing your agree to our <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal">Terms and Conditions.</a>
        </label>
      </div>
{/* Modal */}
        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <p>Welcome to TicketMate. These terms and conditions govern your use of our online ticket reservation and payment services.</p>
              ...
              <ul>
                <li>By booking a seat through our platform, you agree to abide by these terms and conditions.</li>
                <li>All payments are securely processed through our platform. By completing a payment, you authorize us to proceed with the booking.</li>
              </ul>

              <h5>3. Cancellations and Refunds</h5>
              <ul>
                <li className="alert alert-danger">You may cancel your seat booking within 24 hours of making the payment. Cancellations made after this period may not be eligible for a refund.</li>
                <li>Refunds for cancellations made within 24 hours will be processed to the original payment method used during booking. Refunds are subject to processing fees.</li>
              </ul>

              <h5>4. Seat Reservation</h5>
              <ul>
                <li>Seat availability is subject to change and is not guaranteed until payment is successfully processed.</li>
                <li>Changes to seat reservations are subject to availability and may incur additional charges.</li>
              </ul>

              <h5>5. Privacy and Security</h5>
              <ul>
                <li>We are committed to protecting your privacy. Your personal information is securely stored and used only for ticketing purposes.</li>
                <li>Our platform uses industry-standard encryption and security measures to protect your payment and personal information.</li>
              </ul>

              <h5>6. Contact Us</h5>
              <ul>
                <li>For any inquiries or assistance regarding your booking, please contact our customer support team at <a href="tel:+94719151160">+94 71 9151160</a> or email us at <a href="mailto:ticketmatePTES@gmail.com">ticketmatePTES@gmail.com</a>.</li>
              </ul>

              <h5>7. Amendments to Terms</h5>
              <p>We reserve the right to amend these terms and conditions at any time. Changes will be effective immediately upon posting on our website.</p>
      ...
      <div className="card p-3 shadow-sm">
        <div className="container text-center">
          <div className="row align-items-center mb-3">
            <div className="col text-start" style={{ fontFamily: "Poppins", fontSize: "24px", fontWeight: "bold" }}>
              Passengers
            </div>
          ...
          <div className="row align-items-center">
            <div className="col text-start" style={{ fontFamily: "Poppins", fontSize: "32px", fontWeight: "bold" }}>
              Total
            </div>
