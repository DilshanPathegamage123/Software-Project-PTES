...
import train3 from "./TravelDetailsCardAssests/train3.png";
...
const DetailsCard2: React.FC<DetailsCard2Props> = ({
  ...
  return (
    <div className={cardClass}>
      {/* column 1 */}
      <div className="col col-lg-3 col-md-10 col-12 p-0 pt-3 d-flex justify-content-center align-items-center">
        <div className="col ms-xl-0 ms-5 mt-xl-1 mt-3 ps-0">
          <img
            src={(() => {
              if (selectedVehicleType === "Bus") return Bus1;
              if (selectedVehicleType === "Train") return train3;
            })()}
            alt="VehicleIcon"
