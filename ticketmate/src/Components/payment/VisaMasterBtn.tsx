...
// //   </div>
// //   <div className="col-2">
// //     <button type="button" className="btn btn-w-100" style={buttonStyle2} onClick={handleMasterPaymentClick}>
...
// function VisaMasterBtn() {
//   const [visaButtonClicked, setVisaButtonClicked] = useState(true); // Set default to true
//   const [masterButtonClicked, setMasterButtonClicked] = useState(false);
...
interface VisaMasterBtnProps {
  onPaymentMethodSelect: (method: string) => void;
}

const VisaMasterBtn: React.FC<VisaMasterBtnProps> = ({ onPaymentMethodSelect }) => {
  const [visaButtonClicked, setVisaButtonClicked] = React.useState(true);
  const [masterButtonClicked, setMasterButtonClicked] = React.useState(false);
