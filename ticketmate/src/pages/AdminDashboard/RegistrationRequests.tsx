...
const RegistrationRequests = () => {
  ...
  const rejectOwner = (id:number) => {
    ...
    .then((response)=>{
      ...
      setUserData(userData.filter((user)=>{return user.id !== id}))
    })
    .catch((error)=>{
      console.log(error);
    }
              ...
              {userData.map((user) => (
                <tr key={user.id}>
                  ...
                  {/* onClick={() => toggleModel1(user)} */}
                      ...
                      <button className="btn viewbutton"
                      onClick={()=>toggleModel1(user)}>
                        View
                      </button>
                          ...
                          <div className="col-12" style={{ color: "white" }}>
                            <table>
                              ...
                              <tr>
                                ...
                                <td>{selectedUser && selectedUser.drivingLicenseNo}</td>
                              </tr>
                              <tr>
                                <td>Own vehicle type : </td>
                                <td> {selectedUser && selectedUser.ownVehicleType}</td>
                              </tr>
                            </table>
                          </div>
